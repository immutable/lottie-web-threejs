  ...
  renderElement: function () {
    ...
    if (transformedElement && this.finalTransform._matMdf) {
      ...
      if (this.p) {
        ...
        const newPosition = new three.Vector3(this.p.v[0], -this.p.v[1], -this.p.v[2]);
...
THRShapeElement.prototype.createContent = function () {
  ...
  const geometry = new three.PlaneGeometry(this.data.sw, this.data.sh);
  const material = new three.MeshBasicMaterial({ color: this.data.sc, side: three.DoubleSide });
...
THRSolidElement.prototype.createContent = function () {
  ...
  const geometry = new three.PlaneGeometry(this.data.sw, this.data.sh);
  const material = new three.MeshBasicMaterial({ color: this.data.sc });
  this.material = material;
  const plane = new three.Mesh(geometry, material);
  // plane.rotation.order = 'ZYX';
  this.baseElement.add(plane);
        ...
        for (i = 0; i < len; i += 1) {
          ...
          if (comp.type === '3d') {
            if (hasMatrixChanged) {
              ...
              // LookAt
              if (this.a) {
                const cameraLookAt = new three.Vector3(this.a.v[0], -this.a.v[1], -this.a.v[2]);
...
ThreeRendererBase.prototype.configAnimation = function (animData) {
  ...
  let three$1 = this.globalData.renderConfig.renderer;
  if (!three$1) {
    three$1 = {};
  ...
  if (three$1.interaction === true) {
    three$1.interaction = new a(
      three$1.renderer,
      three$1.camera,
      three$1.renderer.domElement
    );
