...
ThreeRendererBase.prototype.configAnimation = function (animData) {
  ...
  var camera = new THREE__namespace.PerspectiveCamera(75, animData.w / animData.h, 0.1, 1000);
  var renderer = new THREE__namespace.WebGLRenderer();
  renderer.setSize(animData.w, animData.h);

  // Create a plane geometry
  var planeGeometry = new THREE__namespace.PlaneGeometry(10, 10);
  ...
  var material = new THREE__namespace.MeshBasicMaterial({ map: texture });

  // Create a mesh using the plane geometry and material
  var plane = new THREE__namespace.Mesh(planeGeometry, material);
  ...
  // var resizerElem = renderer.domElement;
  // var style = resizerElem.style;
  // style.width = animData.w + 'px';
  // style.height = animData.h + 'px';
  // this.resizerElem = resizerElem;
...
ThreeRendererBase.prototype.renderFrame = SVGRenderer.prototype.renderFrame;

ThreeRendererBase.prototype.hide = function () {
  this.resizerElem.style.display = 'none';
};

ThreeRendererBase.prototype.show = function () {
  this.resizerElem.style.display = 'block';
};
...
ThreeRenderer.prototype.checkLoaded = function () {
  ...
  // if (this.globalData.isAssetsLoaded) {
  //   if (!this.isLoaded
  //     && this.renderer.globalData.fontManager.isLoaded
